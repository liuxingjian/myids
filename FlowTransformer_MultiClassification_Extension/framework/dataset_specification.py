...
class NamedDatasetSpecifications:
    ...
    cse_cic_ids_2017 = DatasetSpecification(
        include_fields=['Destination Port', 'Flow Duration', 'Total Fwd Packets',
        ...
        categorical_fields=['Destination Port', 'Fwd PSH Flags', 'Bwd PSH Flags', 'Fwd URG Flags', 'Bwd URG Flags', 'CWE Flag Count', 'ECE Flag Count'],
        benign_label='BENIGN',
        class_column='Label'
    )

    CICFlowMeter_flow_format = DatasetSpecification(
        include_fields=[
